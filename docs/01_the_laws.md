...
*v2.1 evolution chain fix — there is no such thing as 100% MASTERED — evolution chain Low 1-100% → Mid 1-100% → High — suitable techniques fuse like three fuse and become a High, how logically things work — user correction: basic walking and running low it go 1 to 100% the just as it reach 100% that' second it evolve into next like imagine silent wind step, mid level , then it's go same 1 to 100% then as it's reach 100% , it's become next, ghost Frost Strom step, High then it's same, Yes suitable techniques can fuse like three fuse and become a High and others many, how logically thing's work There is no such thing : 100% · MASTERED*
